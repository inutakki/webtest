...
agent none
    ...
    stages {
      stage('Initialization') {
		...
		sh " curl  -L -O https://github.com/thoughtworks/talisman/releases/download/v1.11.0/talisman_darwin_amd64; chmod +x talisman_darwin_amd64; ./talisman_darwin_amd64 --scan"
