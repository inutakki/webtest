...
agent none
    ...
    stages {
      stage('Initialization') {
		...
		sh ( returnStdout: true, script: "mkdir talisman; cd talisman; curl -L -O https://github.com/thoughtworks/talisman/releases/download/v1.11.0/talisman_darwin_amd64")
